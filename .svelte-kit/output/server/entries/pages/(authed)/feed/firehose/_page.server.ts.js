import { a as selectFirehoseFeed } from "../../../../../chunks/feed2.js";
...
const load = async ({ locals: { safeGetSession } }) => {
  ...
  if (updateReaction) {
    const reactionPost = feedItems.find((item) => item.now_playing_post_id == nowPlayingPostId);
    reactionPost.reaction_active = updatedReactionActive;
