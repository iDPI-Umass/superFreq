...
type LayoutRouteId = RouteId | "/" | "/(admin)/moderation" | "/(admin)/tests/redirect" | "/(authed)/account" | "/(authed)/account/update-email" | "/(authed)/account/update-username" | "/(authed)/feed" | "/(authed)/feed/firehose" | "/(authed)/sign-out" | "/(authed)/user/[username]" | "/(authed)/user/[username]/collections" | "/(authed)/user/[username]/collections-following" | "/(authed)/user/[username]/now-playing-posts" | "/(authed)/user/[username]/users-following" | "/(authed)/user/top-albums" | "/about" | "/about/guidelines" | "/about/updates" | "/auth/confirm-sign-in" | "/auth/error" | "/collection/[collectionId=integer]" | "/collection/[collectionId=integer]/edit" | "/collection/new" | "/collections" | "/create-profile" | "/posts" | "/posts/[username]/now-playing/[timestamp]" | "/posts/now-playing/new" | "/users" | "/welcome" | "/welcome/invite-request" | "/welcome/logo" | "/welcome/sandbox" | "/welcome/scripts" | null
type LayoutParams = RouteParams & { username?: string; collectionId?: MatcherParam<typeof import('../../../../src/params/integer.js').match>; timestamp?: string }
