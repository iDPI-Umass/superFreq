...
<div class="panel" id="profile-info">
	<PanelHeader>
		{#snippet headerText()}
			<span> sign up for Freq </span>
		{/snippet}
	</PanelHeader>
	<div class="form-wrapper">
		<form class="form-column" method="POST" action="?/invite" use:enhance>
			<div class="label-group">
				<label class="text-label" for="email"> Email address </label>
			</div>
			<input class="text" type="email" name="email" id="email" bind:value={email} />
			<div class="label-group">
				<label class="text-label" for="referred-by"> How did you hear about Freq? </label>
			</div>
			<input class="text" type="text" name="referred-by" id="referred-by" bind:value={referredBy} />
			<fieldset class="search">
				<p>
					According to our <a href="/about#guidelines">community guidelines</a>, what should you do
				...
				<ul>
					<li>
						...
						/>
						<label for="listen"> Listen to music </label>
					</li>
					<li>
						<input
							class="radio"
					...
					<li>
						<input
							...
							bind:group={quizAnswer}
						/>
						<label for="fight"> Start a fight with a stranger </label>
					</li>
					<li>
						<input
							class="radio"
							...
							bind:group={quizAnswer}
						/>
						<label for="doubt"> Sit with your doubt </label>
					</li>
				</ul>
			</fieldset>
			<button
