...
<div class="panel" id="profile-info">
	...
	<div class="form-wrapper">
		...
		>
			...
			<input class="text" type="url" name="website" id="website" value={website} />
			<input
				type="hidden"
				name="avatarItem"
				id="avatarItem"
...
<NotificationModal showModal={invalidUsername || form?.validUsername == false}>
	{#snippet headerText()}
		<span> Username contains bad characters </span>
	{/snippet}
	{#snippet message()}
		<span>
			Usernamess only contain letters (a-z or A-Z), digits (0-9), and underscores(_) and must be at
			least 3 characters long.
		</span>
	{/snippet}
</NotificationModal>

<RedirectModal showModal={showRedirectModal} {delay} redirectPath={'/about/guidelines'}>
	{#snippet headerText()}
		<span> Profiled created! </span>
	{/snippet}
	{#snippet message()}
		<span>
