<script lang="ts">
	...
	collectionData.deletedItems = deletedCollectionContents
		? deletedCollectionContents
		: ([] as App.RowData[]);
...
<div class="panel">
	...
	>
		...
		{#key collectionData.deletedItems.length}
			...
			/>
		{/key}
		<button class="double-border-top" type="submit" disabled={loadingSubmission}>
			<div class="inner-border">submit</div>
		</button>
	</form>
	<CollectionEditor limit="8" mode="release_group"></CollectionEditor>
</div>
