...
<div class="panel" id="profile-info">
	...
	<form class="horizontal" id="account-data" method="POST">
		<div class="form-column">
			...
			<input
				...
				disabled
			/>
			<label class="text-label" for="new-email" form="account-data"> New Email Address </label>
			<input
				class="text"
				type="text"
				name="new-email"
				...
				bind:value={newEmail}
			/>
			<label class="text-label" for="confirm-email" form="account-data">
			...
			/>
			<button type="submit" class="standard" disabled={newEmail == '' || newEmail != confirmEmail}>
