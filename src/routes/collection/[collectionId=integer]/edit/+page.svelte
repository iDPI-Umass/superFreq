...
<div class="collection-container">
	...
	<form class="horizontal" method="POST" action="?/updateCollection">
		<div class="form-column">
			...
			<input
				...
				required
			/>
			<input type="hidden" name="status" value={collectionData.status} />
		...
		<div class="form-column">
			...
			<div class="collection-info-button-spacing">
				<button type="button" class="double-border-top" onclick={() => (showModal = true)}>
					<div class="inner-border">delete collection</div>
				</button>
				<button
				...
				>
					<div class="inner-border">save edits</div>
				</button>
			</div>
		</div>
	</form>
