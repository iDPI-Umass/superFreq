...
<script lang="ts">
	...
	*/
	...
	import { insertCollectionInfo, insertCollectionSocial, insertCollectionContents, insertCollectionUpdateRecord } from '$lib/resources/backend-calls/collectionInsertUpsertFunctions'
	...
	*/
	...
	async function upsertMusicData({locals: { supabase }}: { locals: any }) {
	...
	async function submitCollectionInfo({ locals: { supabase }}: { locals: any }) {
	...
	async function submitCollectionContents({ locals: { supabase }}: { locals: any }) {
