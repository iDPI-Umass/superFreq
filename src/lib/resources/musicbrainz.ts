...
export const getCoverArt = async function ( release_group_mbid: string ) {
...
export const checkDuplicate = function ( item: App.RowData, addedItems: App.RowData | App.RowData[], mbidCategory: string ) {
...
export const addCollectionItem = async function ( 
    ...
    const isDuplicate = checkDuplicate( item, addedItems, mbidCategory )
