...
<div class={imgOrientation[orientation][0]}>
	<CoverArt
		...
		{imgUrl}
		altText={imageOne
			? `${imageOne['release_group_name']} by ${imageOne['artist_name']}`
			: 'album cover'}
	...
	<CoverArt
		...
		{imgUrl}
		altText={imageTwo
			? `${imageTwo['release_group_name']} by ${imageTwo['artist_name']}`
			: 'album cover'}
	...
	<CoverArt
		...
		{imgUrl}
		altText={imageThree
			? `${imageThree['release_group_name']} by ${imageThree['artist_name']}`
			: 'album cover'}
