<script lang="ts">
	...
	let { sessionUserId, username, displayName, avatarItem, logo }: ComponentProps = $props();
...
<div class="grid-background">
	<header>
		...
		<nav class="wide">
			{#if sessionUserId}
				<a href="/feed">
					<button class="nav"> feed </button>
				</a>
				<a href="/posts/now-playing/new">
					<button class="nav"> post </button>
				</a>
				<Dropdown
      ...
      ></Dropdown> -->
			...
			{:else}
				...
				<a href="/welcome">
					<button class="nav"> log in/sign up </button>
				</a>
			{/if}
		</nav>
		<nav class="narrow">
